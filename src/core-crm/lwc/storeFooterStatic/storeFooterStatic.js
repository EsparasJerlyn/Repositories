 ...
 *    | ryan.j.a.dela.cruz        | September 28, 2023    | DEPP-5283            | Added why we collect personal information link         |
 */
...
const LEGAL_LINK = "https://www.qut.edu.au/additional";
const PRIVACY_LINK = "https://www.qut.edu.au/additional/privacy";
const WHY_WE_COLLECT_LINK =
  "https://www.qut.edu.au/about/governance-and-policy/privacy-and-access-to-information/personal-information/personal-information-register";
...
export default class StoreFooterStatic extends LightningElement {
      ...
      if (result.data) {
        this.CategoriesNavigationMenuList = result.data.forEach((Category) => {
          ...
          if (Category.SortOrder == "1") {
            this.navTailoredExecEduc =
              basePath +
              "/category/" +
              Category.Name.replaceAll(" ", "-").toLowerCase() +
              "/" +
              Category.Id.slice(0, -3);
  ...
  get subMenuHome() {
    ...
    if (
      ...
      window.location.pathname == extendedBasePath1 ||
      window.location.pathname == extendedBasePath2
    ) {
  ...
  get whyWeCollectLink() {
    return WHY_WE_COLLECT_LINK;
  }
