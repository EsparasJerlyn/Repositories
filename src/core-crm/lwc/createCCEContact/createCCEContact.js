 ...
 *    |                           |                       | DEPP-4489    |                                                             |
 *    | ryan.j.a.dela.cruz        | August 14, 2023       | DEPP-6376    | Added Nebula Logger                                                             |
 */
  ...
  handleSubmit(event) {
    ...
    validateContactMatching({ newContactList: JSON.stringify(contactList) })
      .then((res) => {
        ...
        if (
          validationResult.isPartialMatch == false &&
          ...
          fields = {
            ...
            ContactMobile_Locale__c:
              event.detail.fields.ContactMobile_Locale__c,
            ...
            Accessibility_Requirement__c:
              event.detail.fields.Accessibility_Requirement__c,
            hed__Primary_Organization__c: this.recordId,
            RecordTypeId: Object.keys(recTypes).find(
              (rti) => recTypes[rti].name == RT_Contact_Person
            )
          };
          this.template
      ...
      .catch((error) => {
        ...
        if (logger) {
          logger.error(
            "Exception caught in method handleSubmit in LWC createCCEContact: ",
